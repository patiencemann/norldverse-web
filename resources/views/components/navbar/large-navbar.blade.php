<div class="flex items-center">
    ...
    <div>
        <a download="/apks/Norldverse-v1.0.0-feb-2024.apk" href="/apks/Norldverse-v1.0.0-feb-2024.apk" class="text-white font-calistoga bg-[#80a49a] hover:bg-[#4285F4]/80 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 rounded-full text-sm px-4 py-3 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2">
            ...
            <span class="mt-1 font-calistoga" style="font-size: 13px">Android</span>
        </a>
    </div>
