<div class="flex items-center">
    ...
    <div>
        <a download="/apks/Norldverse-v1.0.0-feb-2024.apk" href="/apks/Norldverse-v1.0.0-feb-2024.apk" class="download-app text-white font-calistoga bg-[#80a49a] hover:bg-[#4285F4]/80 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 rounded-full text-sm px-4 py-3 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 -ml-1 w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 1.5H8.25A2.25 2.25 0 0 0 6 3.75v16.5a2.25 2.25 0 0 0 2.25 2.25h7.5A2.25 2.25 0 0 0 18 20.25V3.75a2.25 2.25 0 0 0-2.25-2.25H13.5m-3 0V3h3V1.5m-3 0h3m-3 18.75h3" />
            </svg>
            <span class="mt-1 font-calistoga download-app-text" style="font-size: 13px">Android</span>
        </a>
    </div>
    ...
    @if (!Auth::check())
        <div class="auth-btns">
            <a href="{{ route('init.oauth', ['google']) }}" class="text-white font-calistoga bg-[#4285F4]/90 hover:bg-[#4285F4]/80 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 rounded-full text-sm px-4 py-3 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2">
                ...
                <span class="mt-1 font-calistoga" style="font-size: 13px">Continue with Google</span>
            </a>
            <a href="{{ route('init.oauth', ['github']) }}" class="text-white font-calistoga bg-[#24292F]/90 hover:bg-[#24292F]/80 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 rounded-full text-sm px-4 py-3 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2">
                ...
                <span class="mt-1 font-calistoga" style="font-size: 13px">Continue with Github</span>
            </a>
        </div>
    @endif
