                ...
                <div class="rounded-xl bg-white shadow-xl">
                    <div class="p-6 sm:p-16">
                        ...
                        <div class="mt-16 grid space-y-4">
                            ...
                            <button class="group h-12 px-6 border-1 bg-gray-200 hover:bg-gray-900 hover:text-white border-gray-300 rounded-full transition duration-300 hover:border-white focus:bg-white active:bg-blue-100">
                                <div class="relative flex items-center space-x-4 justify-center">
