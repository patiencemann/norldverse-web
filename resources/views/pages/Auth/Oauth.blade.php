                ...
                <div class="rounded-xl  shadow-xl dark:bg-gray-700">
                    ...
                    <div class="p-6 sm:p-16">
                        ...
                        <div class="mt-16 grid space-y-1">
                            ...
                            <a href="{{ route('init.oauth', ['github']) }}" class="text-white font-anek bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-full text-lg px-5 py-4 text-center inline-flex items-center justify-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                                ...
                                <span class="mt-1" style="font-size: 19px">Gihub Account</span>
                            </a>
                        </div>
                    </div>
                </div>
