                        ...
                        <div>
                            <div class="mb-6">
                                @foreach ($doc->docTopic->topics as $topic)
                                    <button class="rounded-full bg-slate-800 capitalize py-2.5 px-4 text-md font-semibold text-white hover:bg-slate-700 focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white/50 active:text-slate-400">{{ $topic }}</button>
                                @endforeach
                            </div>
                        ...
                        <div class="flex justify-between items-center post-socials">
                            <div class="post-meta">
                                ...
                                <div class="post-meta-content ml-4">
                                    ...
                                    <strong class="text-gray-300 font-bold mt-1">Published: {{ $doc->created_at->diffForHumans() }}</strong>
                                    <read-time text="{{ $doc->contents }}" class="mt-2"/>
                                </div>
                            </div>
                        </div>
