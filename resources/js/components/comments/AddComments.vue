    <template>
        <div class="d-flex mt-3">
            ...
            <form class="mb-6 w-full ml-4">
                ...
                <button type="button" style="font-size: 16px !important;" :disabled="isLoading" @click="createComment()" class="disabled:opacity-75 relative p-4 h-22 w-56 inline-flex font-anek items-center justify-center py-2.5 px-4 text-sm font-bold text-center text-white bg-deep-green-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800 border border-[#dbe0e4] dark:border-none">
                    Post comment
