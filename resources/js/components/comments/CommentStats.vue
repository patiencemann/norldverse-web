<template>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg font-anek text-gray-900 dark:text-white" style="font-size: 25px">Discussion ({{ Object.keys(comments).length }})</h2>
        <div class="flex -space-x-4">
            <img class="w-10 h-10 rounded-full border-2 border-white dark:border-gray-800" :src="user.user.avatar" alt="" v-for="user in uniqueUser.slice(0, limit)" :key="user.id">
