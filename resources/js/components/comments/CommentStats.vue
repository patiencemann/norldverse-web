<template>
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-lg font-anek text-gray-900 dark:text-[#E8E8ED]" style="font-size: 25px">
            ...
            <button @click="likeDoc('id-'+doc)" :id="'id-'+doc" type="button" v-if="auth" :class="(liked?'bg-blue-600 ml-3 text-white':'bg-white text-black')+' animate-pulse z-10 hover:bg-blue-200 shadow-sm ring-4 ring-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'">
