    <template>
        <div class="comment-wrapper mt-3">
            ...
            <div class="p-6 mb-6 text-base bg-white border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900 rounded" v-for="comment in comments" :key="comment.id">
                ...
                <p class="text-gray-500 dark:text-gray-400 font-anek">{{ comment.message }}</p>
            </div>
        </div>
    </template>
    <script>
