<template>
    <div role="list" class="grid-halves posts w-dyn-items animate-pulse p-3 rounded">
        <div role="status" class="p-4 w-dyn-item rounded border border-gray-200 md:p-6 dark:border-gray-700">
