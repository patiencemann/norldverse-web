                ...
                <div class="item-image global-image global-image-orientation global-radius is-landscape bg-gray-300">
                    ...
                    <div class="flex items-center justify-center">
                        ...
                        <div class="absolute flex justify-end right-5 bottom-5">
                            <button @click="likeDoc(doc.id, 'id-'+doc.id)" :id="'id-'+doc.id" type="button" :class="(doc.iLiked?'bg-blue-600 text-white':'bg-white text-black')+' animate-pulse z-10 hover:bg-blue-800 shadow-sm ring-4 ring-gray-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'">
                ...
                <div class="item-content">
                    <div class="item-tags global-tags">
                        <span>
                            ...
                            <a class="font-anek font-bold text-gray-500">{{ doc.likes }} likes</a>
                        </span>
                    </div>
